...
class MonthlyTotalIncome extends StatefulWidget {
  @override
  _MonthlyTotalIncomeState createState() => _MonthlyTotalIncomeState();
}

class _MonthlyTotalIncomeState extends State<MonthlyTotalIncome> {
  @override
