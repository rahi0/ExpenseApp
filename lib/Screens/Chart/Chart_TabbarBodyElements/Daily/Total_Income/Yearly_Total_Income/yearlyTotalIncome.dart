...
class YearlyTotalIncome extends StatefulWidget {
  @override
  _YearlyTotalIncomeState createState() => _YearlyTotalIncomeState();
}

class _YearlyTotalIncomeState extends State<YearlyTotalIncome> {
  @override
