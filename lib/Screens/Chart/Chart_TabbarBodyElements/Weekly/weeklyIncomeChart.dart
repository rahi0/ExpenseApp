...
class WeeklyIncomeChart extends StatefulWidget {
  @override
  _WeeklyIncomeChartState createState() => _WeeklyIncomeChartState();
}

class _WeeklyIncomeChartState extends State<WeeklyIncomeChart> {
  bool toggle = false;
