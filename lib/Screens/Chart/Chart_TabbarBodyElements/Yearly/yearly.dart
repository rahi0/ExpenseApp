import 'package:expanse_manegment/Screens/Chart/Chart_TabbarBodyElements/Yearly/yearlyExpenseChart.dart';
import 'package:expanse_manegment/Screens/Chart/Chart_TabbarBodyElements/Yearly/yearlyIncomeChart.dart';
...
class _YearlyState extends State<Yearly> {
 WidgetMarker selectedWidgetMarker = WidgetMarker.income;
  ...
  Widget getIncomeWidget() {
    return Container(
     child: YearlyIncomeChart(),
    );
  }
    Widget getExpenseWidget() {
    return Container(
      child: YearlyExpenseChart(),
